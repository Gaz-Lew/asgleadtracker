...
export default function Home() {
  ...
  // --- Client-side Initialization and Online/Offline Status ---
  useEffect(() => {
    // Safely initialize state from browser APIs after component mounts
    setLeads(getFromStorage('leadAppLeads', []));
